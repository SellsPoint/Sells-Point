...
export default function CtaBand() {
  ...
  return (
    <section className="bg-ink-50 py-4 sm:px-6">
      <div className="cta-gradient home-container grid overflow-hidden rounded-3xl px-6 py-8 sm:px-10 sm:py-9 lg:grid-cols-[190px_minmax(0,1fr)_auto] lg:items-center lg:gap-10">
        <div className="order-2 mx-auto hidden w-36 self-end sm:block lg:order-1 lg:mx-0 lg:w-full">
          <img
        ...
        >
          Post Your Ad Now <ArrowRight size={19} />
        </button>
      </div>
    </section>
  );
