        ...
        <div className="lg:pb-5">
          ...
          <div className="relative mt-9 grid gap-9 sm:grid-cols-3 sm:gap-7">
            ...
            {steps.map(({ icon: Icon, title, text }) => (
              <div key={title} className="relative max-w-[17rem]">
                <span className="relative z-10 flex h-[4.5rem] w-[4.5rem] items-center justify-center rounded-full border border-brand-400 bg-brand-500 text-white shadow-glow ring-4 ring-ink-50">
